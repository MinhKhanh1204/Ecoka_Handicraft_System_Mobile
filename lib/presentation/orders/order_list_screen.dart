      ...
      body: Builder(
        builder: (context) {
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  const Text('Hãy mua sắm để tạo đơn hàng',
          ...
          return RefreshIndicator(
            onRefresh: () => ref.read(orderControllerProvider.notifier).loadOrders(),
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text('Tổng tiền:', style: TextStyle(color: Colors.grey.shade600)),
                  Text(
